...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- (ИЗМЕНЕНО) Функция: Инициализация ---
    ...
    dealerListBody.addEventListener('click', async (e) => {
        ...
        if (editButton) {
            ...
            openEditModal(id); // Вызываем нашу новую функцию
        }
