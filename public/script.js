...
// --- 1. АВТОРИЗАЦИЯ ---
    ...
    const API_RECLAMATIONS_URL = '/api/reclamations'; // <-- ДОБАВЛЕНО ДЛЯ ДАШБОРДА
    ...
    let allReclamations = []; // <-- ДОБАВЛЕНО ДЛЯ ДАШБОРДА
    let chartSpeedometer = null; // <-- ДОБАВЛЕНО ДЛЯ ДАШБОРДА
    let chartRings = null; // <-- ДОБАВЛЕНО ДЛЯ ДАШБОРДА
