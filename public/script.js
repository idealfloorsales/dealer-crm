document.addEventListener('DOMContentLoaded', () => {
    ...
    // Глобальная функция для onchange
    ...
    // ==========================================
    // 5. ЛОГИКА ОТРИСОВКИ (DASHBOARD & LIST)
    // ==========================================
    ...
    // Handlers для фото (Upload / Remove)
    ...
    if(openAddModalBtn) openAddModalBtn.onclick = () => { 
        ...
        if(addAvatarPreview) { addAvatarPreview.src = ''; addAvatarPreview.style.display='none'; } 
    ...
    // --- 7. OPEN EDIT (HOISTED COPY) ---
    // Это копия функции, чтобы она была доступна в глобальной области видимости для onclick
