document.addEventListener('DOMContentLoaded', () => {
    ...
    // !!! ИСПОЛЬЗУЕМ КОНТЕЙНЕР ДЛЯ КАРТОЧЕК !!!
    ...
    function renderDashboard() {
        ...
        // А ЗАДАЧИ РЕНДЕРИМ В СПИСКИ ВНИЗУ
