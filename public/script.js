document.addEventListener('DOMContentLoaded', () => {
    ...
    // OPEN EDIT (ИСПРАВЛЕНО - теперь эта функция точно существует)
    ...
    async function duplicateDealer(id) {
        try {
            ...
            currentStep = 1; showStep(1); addModal.show(); alert("Скопировано. Введите новый ID.");
