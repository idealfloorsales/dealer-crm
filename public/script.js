    ...
    async function initApp() {
        ...
        try { 
            ...
            if(r.ok) { 
                ...
                renderDashboard(); // РЕНДЕРИМ ДАШБОРД
            } 
        } catch(e) { 
